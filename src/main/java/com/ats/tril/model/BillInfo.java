...
public class BillInfo {
	...
	public BillInfo(int billDetailId, int billId, String vendor, int vendorCreditDays, String billBookNo, String date,
			String billNo, String billDate, String productName, String uom, String rate, String qty, String rateTotal,
			String cgst, String sgst, String igst, String otherCharges, String discValue, String totalAmount) {
		super();
